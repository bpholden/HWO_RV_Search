...
``rvsearch`` requires Python 3.10 or later and `RadVel <http://radvel.readthedocs.org>`_
1.6.1 or later. Earlier RadVel releases cannot be built on modern Python, and
RadVel 1.4-1.5 changed the parameter-evaluation API in a way that silently
breaks the search.
